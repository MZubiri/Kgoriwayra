...
namespace Kgoriwayra.WebApi.Middleware;
...
public class ExceptionHandlingMiddleware
{
    ...
    private static async Task HandleExceptionAsync(HttpContext context, Exception exception)
    {
        ...
        var response = ApiResponse<string>.Fail("Ha ocurrido un error interno en el servidor.", new List<string> { exception.Message });
